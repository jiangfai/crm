...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="57%"align="right">
    	...
    	<%--员工注入 --%>
	  	<a href="${pageContext.request.contextPath}/addPreStaff.do">
...
<!-- 查询条件：马上查询 -->
<form id="conditionFormId" action="${pageContext.request.contextPath}/staffAll.do" method="post">
  ...
  <tr class="henglan" style="font-weight:bold;">
    ...
    <c:forEach items="${staffList }" var="item">
	  <tr class="tabtd1"> 
	    ...
	    <td align="center">${item.onDutyDate }</td>
